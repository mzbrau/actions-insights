...
Use this checklist to verify your Actions Insights setup before merging. AI assistants should complete every item in Phase 7 of the [AI Setup Guide](./ai-setup).
...
5. **History dashboard** — visit the GitHub Pages URL and confirm the latest run appears (if history repository is enabled); if coverage is enabled, confirm the **Test Coverage** tab shows trend data
