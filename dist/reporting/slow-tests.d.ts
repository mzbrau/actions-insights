...
export declare function formatSlowTestLine(test: TestCase, slowThresholdMs: number, shortName?: string): string;
...
export declare function formatAllTestLine(test: TestCase, shortName: string): string;
